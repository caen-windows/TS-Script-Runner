...
$Message = "The Windows 10 EBD is only available by request. Please contact caen@umich.edu with the computer name, MAC address, and SMBIOS GUID of the system, as well as the reason Windows 10 is required. `n`nMicrosoft support of Windows 10 ends in October 2025 and all Windows 10 EBD systems will need to be reloaded with Windows 11 or decommissioned by then.`n`nMAC: [ $mac ]`nSMBIOS GUID: [ $smbiosguid ]" 
