...
$Message = "The Windows 10 EBD is available by request only. Please contact caen@umich.edu with the computer name, MAC address, SMBIOS GUID, and hardware model of the system, as well as the reason Windows 10 is required. `n`nIn October 2025 Windows 10 reaches end of support from Microsoft. All Windows 10 EBD systems must be decommissioned or reloaded with Windows 11 by then.`n`nYour system information:`nMAC Address: [ $mac ]`nSMBIOS GUID: [ $smbiosguid ]" 
